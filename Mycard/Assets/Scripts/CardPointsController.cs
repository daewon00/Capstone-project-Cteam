...
{   //카드의 턴동안의 행동을 담당하는 스크립트입니다
    ...
    public void PlayerAttack()
    {
        ...
        GameLog.Info("[CardPointsController] PlayerAttack -> MoveTo battleTransform");
#endif
    ...
    IEnumerator PlayerAttackCo()
    {
        ...
        for (int i = 0; i < playerCardPoints.Length; i++)
        {
            ...
            int finalAtk = playerCard != null ? playerCard.CalculateCombatAttack() : 0;
            if (playerCard == null)
                continue;
    ...
    IEnumerator EnemyAttackCo()
    {
        ...
        for (int i = 0; i < enemyCardPoints.Length; i++)
        {
            ...
            int finalAtk = enemyCard.CalculateCombatAttack();
